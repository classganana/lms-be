...
export class UpdateUserDto {
  ...
  @ApiPropertyOptional({ example: 'john.doe@example.com', description: 'Email address (must be unique)' })
  @IsEmail()
  @IsOptional()
  email?: string;
  ...
  @ApiPropertyOptional({ example: 'SecurePassword123!', description: 'Password (minimum 6 characters)' })
  @IsString()
  @MinLength(6)
  @IsOptional()
  password?: string;

  @ApiPropertyOptional({ example: 'NON_ADMIN', enum: ['ADMIN', 'NON_ADMIN'], description: 'User role' })
