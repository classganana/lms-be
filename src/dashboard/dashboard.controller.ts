...
export class AdminDashboardController {
  ...
  @ApiQuery({ name: 'startDate', required: false, type: String, description: 'Start date filter (ISO 8601 format)', example: '2026-01-01T00:00:00.000Z' })
  @ApiQuery({ name: 'endDate', required: false, type: String, description: 'End date filter (ISO 8601 format)', example: '2026-01-31T23:59:59.999Z' })
  @ApiResponse({ 
    status: 200, 
